...
| A-2b | Cancel 再 New 的更正 | ~~把版本链从一跳拉到两跳~~ **2026-09-13 更正：不是两跳链**，重新下达的 New 不回引任何报文，见 §3A.10 | 可解锁，回溯检查已实现 |
...
| C-2c | Cancel 再 New 的更正 | 与 A-2b 同形，**同样不是两跳链** | 可解锁，**与 A-2b 同时** |
