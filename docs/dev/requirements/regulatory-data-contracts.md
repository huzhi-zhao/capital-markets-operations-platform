...
| 第三批 | ISO 20022 结算报文族 | 三种核心报文已从规范 XSD 与 MDR 核对；S-1 已冻结 |
...
**仍有一处读不到：状态转移的合法次序。** MDR Part 1 §5.7 把它交给一张"由 SMPG 商定的决策
图"，**那是图片，文本里没有内容**。§4.4 的三根状态轴因此只登记了取值结构，**没有登记转移
次序**，S-2 落地前必须补。
...
- **状态转移次序未知**，见 §4.1。MDR 把它放在一张 SMPG 决策图里，文本无内容。**S-2 落地前
  必须补**，否则失败与挂起之间的转移全是猜的。
